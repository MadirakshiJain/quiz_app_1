...
class Civil_Home extends StatelessWidget {
  const Civil_Home({super.key});
          ...
          children: <Widget>[
            DrawerHeader(
              ...
              child: Column(
                children: [
                  CircleAvatar(
                    backgroundImage: AssetImage("Assets/civil.png"),
                    radius: 40,
                  ),
                  SizedBox(height: 10,),
                  Text(
              ...
              child: SingleChildScrollView(
                    ...
                    children: [
                      Stack(
                        ...
                        Container(
                          ...
                          child: Text("Welcome to Civil Engineering Branch !",style: TextStyle(  fontSize: 25,color: Color.fromARGB(255, 138, 11, 160),fontWeight: FontWeight.w400))),
                     SizedBox(height: 20),
                ...
                RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15.0),
                              ...
                              context,
                              MaterialPageRoute(
                                  builder: (context) => TestPage(selectedBranch: 'CIVIL',)),
                            );
                                            },
                                            child: Text(
                                              "Test",
